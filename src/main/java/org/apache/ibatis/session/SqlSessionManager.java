...
public class SqlSessionManager implements SqlSessionFactory, SqlSession {
    ...
    /**
     * SqlSession 代理对象，使用JDK的动态代理实现
     */
    private final SqlSession sqlSessionProxy;
    /**
     * ThreadLocal 变量，记录一个与当前线程绑定的 SqlSession对象
     * localSession 中记录的SqlSession对象的代理对象，在SqlSession初始化的时候
     */
